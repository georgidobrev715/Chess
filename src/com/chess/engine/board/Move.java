...
public static final Move NULL_MOVE=new NullMove();
    ...
    public static final class EnPassant extends PawnAttackMove  {
        public    EnPassant(final Board board, final Piece movedPiece,final int destinationCoordinate,final Piece attackedPiece) {
            super(board, movedPiece, destinationCoordinate,attackedPiece);
        }
        @Override
        public boolean equals(final Object other){
            ...
            public static Move createMove(final Board board, final int currentCoordinate, final int destinationCoordinate) {
                for (final Move move : board.getAllLegalMoves()) {
                    if (move.getCurrentCoordinate() == currentCoordinate && move.getDestinationCoordinate() == destinationCoordinate) {
                        System.out.println("Creating move: " + move); // Debugging line
                        return move;
                    }
                }
                System.out.println("Failed to find move for coordinates " + currentCoordinate + " to " + destinationCoordinate); // Debugging line
                return NULL_MOVE;
            }
